...
echo "========================================"
echo "DVC Test Script (No Deployment)"
echo "========================================"
echo ""
...
echo -e "${YELLOW}Getting existing infrastructure info...${NC}"
...
echo -e "${GREEN}✓ Existing infrastructure found${NC}"
...
# Update DVC config to use the bucket
